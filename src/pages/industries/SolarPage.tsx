import { Sun, Phone, TrendingUp, Zap, CheckCircle, ArrowRight } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-deep-purple via-[#101633] to-slate-900 pt-32 pb-24">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-[10%] top-[-8rem] h-[24rem] w-[24rem] rounded-full bg-bright-amber/20 blur-3xl" />
        ...
        <div className="page-shell relative mx-auto max-w-[1400px]">
          ...
          >
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl mb-6">
              <Sun className="h-8 w-8 text-bright-amber" />
            </div>
            <h1 className="font-plus-jakarta-sans text-4xl font-bold leading-tight text-slate-50 sm:text-5xl lg:text-[3.75rem] lg:leading-[1.05]">
              <span className="bg-gradient-to-r from-bright-amber to-vibrant-green bg-clip-text text-transparent">Solar Leads</span> That Actually Convert
            </h1>
            <p className="mt-6 font-inter text-base text-slate-200/80 sm:text-lg">
              Stop wasting time with unqualified prospects. We connect solar companies with homeowners who are ready to invest in clean energy and have the credit, roof space, and motivation to move forward.
            </p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1A1F3B] via-[#101633] to-deep-purple py-28">
        <div className="page-shell relative mx-auto max-w-[1400px]">
          ...
          >
            Why Solar Companies Choose LeadsUp
          </motion.h2>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-bright-amber via-deep-purple to-vibrant-green py-28">
        <div className="page-shell relative mx-auto max-w-[1400px]">
          <motion.div
            variants={fadeInUp}
            initial="hidden"
          ...
          >
            ...
            <p className="mt-6 font-inter text-lg text-white/90">
              Let's build a lead generation system that delivers qualified appointments and high-converting solar leads. Book your free strategy call now.
            </p>
