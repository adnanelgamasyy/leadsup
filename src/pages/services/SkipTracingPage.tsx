...
import SkipTracingForm from '@/components/forms/SkipTracingForm'
...
export default function SkipTracingPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Skip Tracing Form Section */}
      <section id="skip-tracing-form" className="relative overflow-hidden bg-gradient-to-br from-[#060c24] via-[#0d1533] to-[#050815] py-28">
        <div className="absolute inset-0">
          <div className="absolute left-1/4 top-[-8rem] h-[26rem] w-[26rem] rounded-full bg-vibrant-green/15 blur-[170px]" />
          <div className="absolute right-[5%] top-[25%] h-[24rem] w-[24rem] rounded-full bg-action-blue/20 blur-[150px]" />
          <div className="absolute left-1/2 bottom-[-6rem] h-[22rem] w-[22rem] -translate-x-1/2 rounded-full bg-bright-amber/12 blur-[140px]" />
        </div>
        ...
        <div className="page-shell relative mx-auto max-w-[1200px]">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 font-inter text-xs font-semibold uppercase tracking-[0.3em] text-slate-100">
              <Search className="h-4 w-4" />
              Request Skip Tracing
            </span>
            <h2 className="mt-6 font-plus-jakarta-sans text-4xl lg:text-5xl font-bold text-slate-50">
              Get Your Skip Tracing Quote
            </h2>
            <p className="mt-4 max-w-2xl mx-auto font-inter text-lg text-slate-200/80">
              Tell us how many records you need traced and we'll provide you with a competitive quote and fast turnaround time.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-vibrant-green/5 via-transparent to-bright-amber/5 pointer-events-none" />
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-vibrant-green/40 to-transparent" />
